          ...
          <div className="space-y-8">
            ...
            {(analysis.adjustments.length > 0 || (analysis.scenarioAdjustments?.length ?? 0) > 0) && (
              <div className="bg-white rounded-2xl border border-[#EBEBEB] shadow-sm px-6 py-5">
                ...
                {(analysis.scenarioAdjustments?.length ?? 0) > 0 && (
            ...
            {/* Create adjusted scenario — always shown when analysis exists */}
            <div className="bg-white rounded-2xl border border-[#EBEBEB] shadow-sm px-6 py-5">
              <h3 className="text-xs font-semibold text-[#6B7280] uppercase tracking-wide mb-4">Create scenario</h3>
              {createSuccess ? (
